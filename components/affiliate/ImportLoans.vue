...
<v-container fluid>
        <v-card>
            <v-toolbar dark color="primary">
                <v-toolbar-title>IMPORTACIÓN PRÉSTAMOS EN MORA</v-toolbar-title>
            </v-toolbar>
                    ...
                    <v-stepper v-model="e1" editable>
                        ...
                        <v-stepper-items>
                            ...
                            <v-progress-linear
                                ...
                                striped
                            >
                                <strong>Porcentaje de Importación: %</strong>
                            </v-progress-linear>
                            <!-- P R I M E R   P A S O -->
                                            ...
                                            <v-form ref="forStep1">
                                                <v-col cols="12" md="6">
                                                    <v-file-input
                                                        ...
                                                        truncate-length="30"
                                                        outlined
                                                        small-chImportProcessAvailabilityips
                                                        dense
                                                ...
                                                <v-col cols="12" md="6" v-if="import_export.file != null">
                                                    <!-- <strong>Nombre del archivo: {{import_export.file}}</strong> <br> -->
                                                    <strong>Total de registros copiados: {{data_count}}</strong> <br>
                                                </v-col>
                                            </v-form>
                                        </v-card>
                                    </v-card-text>
                                ...
                                <v-card class="mb-12" color="grey lighten-1">
                                    <v-card-text>
                                        <v-card color="white" class="pa-2" >
                                            <v-row>
                                                <v-col cols="12" md="6">
                                                    <!-- <strong>Nombre del archivo:</strong> {{import_export.file}}<br> -->
                                                     <strong>Total de registros copiados:{{data_count}}</strong> <br>
                                                </v-col>
